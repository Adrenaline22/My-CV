...
- Реализация лендинга на курсах от Яндекс.Практикума. Проект представляет собой лендинг, содержащий в себе новые секции такие, как techniques, video, oakley, khan и resources, и функции такие, как анимация, шрифты, фреймы. [Сайт доступен по ссылке](https://adrenaline22.github.io/project2/)
